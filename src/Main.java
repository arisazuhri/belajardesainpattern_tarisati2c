...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        bookService.saveBook(2, "Book 1", "Publisher 1");
        bookService.saveBook(3, "Book 2", null);
        bookService.saveBook(4, "Book 3", "Publisher 3");

        Map<Integer, List<Book>> booksByAuthor = bookService.releaseBooksByAuthor
                (Arrays.asList(1, 2, 3));
